...
const STRINGS = {
  ...
  "spread.other_h":       { en: "Forms of support us",
                            es: "Formas de apoyarnos"},
  "spread.w1_h":       { en: "Add us to your wishlist",
                            es: "Añadenos en tu wishlist"},
  "spread.w1_p":       { en: "It will help us a lot to know that you’re looking forward to the games as much as we are.",
                            es: "Nos ayudará mucho a saber que estais esperando los juegos con tantas ganas como nosotros."},
  "spread.w2_h":       { en: "Follow us on social media",
                            es: "Siguenos en redes sociales"},
  "spread.w2_p":       { en: "You’ll be able to stay up to date with every new development and update about the games.",
                            es: "Podrás estar al tanto de cada avance y novedad de los juegos."},                   
  "spread.w1_btn":       { en: "Grow your wishlist",
                            es: "Agranda tu Wishlist"},
  "spread.w2_btn":       { en: "Follow us",
                            es: "Seguir en redes sociales"},                   
